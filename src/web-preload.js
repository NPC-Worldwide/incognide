...
(function () {
  ...
  window.api = {
    ...
    focusWindowById: (windowId) => invoke('focus-window-by-id', windowId),
    minimizeWindowById: (windowId) => invoke('minimize-window-by-id', windowId),
    maximizeWindowById: (windowId) => invoke('maximize-window-by-id', windowId),
    getDisplays: () => invoke('get-displays'),
    moveWindowToDisplay: (windowId, displayId) => invoke('move-window-to-display', windowId, displayId),
